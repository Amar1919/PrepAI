...
import { FiZap, FiMail, FiLock, FiUser, FiArrowRight, FiLoader } from "react-icons/fi";
    ...
    <div className="min-h-screen flex items-center justify-center bg-base-950 bg-grid-fade px-4">
      <div className="w-full max-w-sm animate-fade-in">
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-xl font-bold text-white">Create your PrepAI account</h1>
          <p className="text-sm text-slate-500 mt-1">Start acing your next interview</p>
        </div>
        ...
        <form onSubmit={handleSignup} className="card p-6 space-y-4">
          ...
          <button type="submit" disabled={loading} className="btn-primary w-full mt-2">
            {loading ? <FiLoader className="animate-spin" size={16} /> : <>Create Account <FiArrowRight size={16} /></>}
          </button>
        </form>
